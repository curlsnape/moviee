  ...
  return (
    <div className="sidenav w-[20%] h-full border-r-[1px] py-10 px-5 border-zinc-600">
      <div className="logo_part text-2xl">
        <i className="ri-tv-fill text-[#6050DC]"></i>
        <span className="ml-3 font-black uppercase font-[gilroy] tracking-wider text-white">
          Movixer.
        </span>
      </div>
  ...
  <span className="ml-2 ">
    Trending
        ...
        <Link
          ...
          to=""
        >
         <i class="ri-tv-2-fill  text-emerald-700 shadow-md"></i>
        ...
        >
         ...
         <i class="ri-clapperboard-fill text-orange-600 shadow-md"></i>
        ...
        <Link
          ...
          to=""
        >
            <i class="ri-group-fill text-purple-600 shadow-md"></i>
